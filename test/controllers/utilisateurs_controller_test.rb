...
class UtilisateursControllerTest < ActionController::TestCase
  ...
  test "should create utilisateur" do
    assert_difference('Utilisateur.count') do
      post :create, utilisateur: { mail: @utilisateur.mail, password: @utilisateur.password, pseudo: @utilisateur.pseudo }
    end
  ...
  test "should update utilisateur" do
    patch :update, id: @utilisateur, utilisateur: { mail: @utilisateur.mail, password: @utilisateur.password, pseudo: @utilisateur.pseudo }
    assert_redirected_to utilisateur_path(assigns(:utilisateur))
  end
